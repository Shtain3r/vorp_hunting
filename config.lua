...
Config.SkinnableAnimals = {
    ...
    [-1076508705] = {
        ...
        givenItem = { "bird", "rspoonf", "rspoonb" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Bird meat", "Roseta Spoonbill feather", "Roseta Spoonbill beak" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [2023522846]  = {
        ...
        givenItem = { "bird", "cockf", "cockc" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Bird meat", "Rooster feather", "Rooster claws" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-466687768]  = {
        ...
        givenItem = { "bird", "boobyf", "boobyb" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Bird meat", "Red-footed booby feather", "Red-footed booby beak" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-575340245]  = {
        name = "Wester Raven",
        givenItem = { "bird", "ravenf", "ravenc" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Bird meat", "Raven feather", "Raven beak" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [1458540991]  = {
        ...
        givenItem = { "game", "raccoont", "raccoons" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Game Meat", "Raccoon tooth", "Raccoon skin" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-541762431]  = {
        ...
        givenItem = { "game", "rabbits", "rabbitpaw" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Game Meat", "Rabbit skin", "Rabbit foot" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [2079703102]  = {
        ...
        givenItem = { "bird", "prairif", "prairib" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Bird meat", "Prairi chicken feather", "Prairi chicken beak" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-1414989025] = {
        ...
        givenItem = { "stringy", "opossumc", "opossums" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Opossum claws", "Stringy meat", "Opossum skin" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [1007418994]  = {
        name = "Berkshire Pig",
        givenItem = { "pork", "pigs", "porkfat" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Pork", "Pig pelt", "Pig fat" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [1416324601]  = {
        ...
        givenItem = { "bird", "peasantf", "peasantb" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Bird meat", "Peasant feather", "Peasant beak" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [1265966684]  = {
        ...
        givenItem = { "bird", "pelicanf", "pelicanb" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Bird meat", "Pelican feather", "Pelican beak" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [1654513481]  = {
        name = "Panther",
        givenItem = { "biggame", "panthers", "panthere" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Big Game Meat", "Panther pelt", "Panther eyes" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [120598262]   = {
        ...
        givenItem = { "bird", "kcondorf", "kcondorb" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Bird meat", "Condor feather", "Condor beak" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-2063183075] = {
        ...
        givenItem = { "bird", "chickenf", "chickenheart" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Bird meat", "Chicken feather", "Chicken heart" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-2073130256] = {
        ...
        givenItem = { "bird", "bbirdf", "bbirdb" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Bird meat", "Cormorant feather", "Cormorant beak" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [90264823]    = {
        name = "Cougar",
        givenItem = { "biggame", "cougars", "cougarf" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Big Game Meat", "Cougar skin", "Cougar tooth" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-50684386]   = {
        ...
        givenItem = { "beef", "cows", "cowh" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Beef", "Cow pelt", "Cow horn" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [480688259]   = {
        name = "Coyote",
        givenItem = { "game", "coyotes", "coyotef" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Game Meat", "Coyote skin", "Coyote tooth" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-564099192]  = {
        name = "Whooping Crane",
        givenItem = { "bird", "daruf", "darub" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Bird meat", "Crane feather", "Crane beak" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [45741642]    = {
        name = "Gila Monster",
        givenItem = { "herptile", "lizards", "lizardl" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Herptile meat", "Lizard pelt", "Lizard foot" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-753902995]  = {
        name = "Alpine Goat",
        givenItem = { "game", "goats", "goathead" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Game Meat", "Goat pelt", "Goat head" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [723190474]   = {
        name = "Canada Goose",
        givenItem = { "bird", "goosef", "gooseb" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Bird meat", "Goose feather", "Goose beak" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-2145890973] = {
        ...
        givenItem = { "bird", "hawkf", "hawkt" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Bird meat", "Hawk feather", "Hawk claws" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [1095117488]  = {
        ...
        givenItem = { "bird", "kbirdf", "kbirdb" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Bird meat", "Tricolor heron feather", "Tricolor heron beak" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-1854059305] = {
        name = "Green Iguana",
        givenItem = { "herptile", "gleguans", "lizardl" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Herptile meat", "Green Iguana pelt", "Lizard foot" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-593056309]  = {
        name = "Desert Iguana",
        givenItem = { "herptile", "dleguans", "lizardl" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Herptile meat", "Desert Iguana pelt", "Lizard foot" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [1751700893]  = {
        name = "Peccary Pig",
        givenItem = { "pork", "pecaris", "porkfat" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Pork", "Peccary skin", "Pig fat" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [386506078]   = {
        name = "Common Loon",
        givenItem = { "bird", "loonf", "loonb" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Bird meat", "Common loon feather", "Common loon beak" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-1098441944] = {
        name = "Moose",
        givenItem = { "biggame", "mooseantler", "mooses" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Big Game Meat", "Moose Antlers", "Moose pelt" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-86244272]   = {
        ...
        givenItem = { "bird", "owlf", "owlt" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Bird meat", "Owl feather", "Owl claws" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [556355544]   = {
        name = "Angus Ox",
        givenItem = { "biggame", "oxhorn", "oxs" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Big Game Meat", "Angus Ox horn", "Ox Pelt" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-1892280447] = {
        ...
        givenItem = { "game", "aligatorto", "aligators" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Game meat", "Aligator Tooth", "Aligator Pelt" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-2004866590] = {
        name = "Alligator",
        givenItem = { "biggame", "aligatorto", "aligators" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "BigGame meat", "Aligator Tooth", "Aligator Pelt" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [759906147]   = {
        ...
        givenItem = { "game", "beavertail", "beawers" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Game meat", "Beaver tail", "Beaver pelt" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [730092646]   = {
        ...
        givenItem = { "bearc", "bbears", "biggame" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Bear claws", "Black Bear skin", "Big Game Meat" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-1550768676] = {
        name = "Chipmunk",
        givenItem = { "chipmunk_c" },
        givenAmount = { 1 },
        givenDisplay = { "Chipmunk" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [1784941179] = {
        name = "Cardinal",
        givenItem = { "cardinal_c" },
        givenAmount = { 1 },
        givenDisplay = { "Cardinal" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-292997097] = {
        name = "Cedar waxwing",
        givenItem = { "cedarwaxwing_c" },
        givenAmount = { 1 },
        givenDisplay = { "Cedar waxwing" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-1763055991] = {
        name = "Crawfish",
        givenItem = { "crawfish_c" },
        givenAmount = { 1 },
        givenDisplay = { "Crawfish" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-930822792] = {
        name = "Frogbull",
        givenItem = { "frogbull_c" },
        givenAmount = { 1 },
        givenDisplay = { "Frogbull" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-1910795227] = {
        name = "Songbird",
        givenItem = { "songbird_c" },
        givenAmount = { 1 },
        givenDisplay = { "Songbird" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-1028170431] = {
        name = "Sparrow",
        givenItem = { "sparrow1_c" },
        givenAmount = { 1 },
        givenDisplay = { "Sparrow" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [510312109] = {
        ...
        givenItem = { "woodpeck01_c" },
        givenAmount = { 1 },
        givenDisplay = { "Red-bellied Woodpecker" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [729471181] = {
        ...
        givenItem = { "woodpeck02_c" },
        givenAmount = { 1 },
        givenDisplay = { "Pileated Woodpecker" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [1465438313] = {
        name = "Grey Squirrel",
        givenItem = { "squirrel_grey_c" },
        givenAmount = { 1 },
        givenDisplay = { "Grey Squirrel" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-2021043433] = {
        ...
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Venison", "Elk antler", "Legendary Elk pelt" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-1747620994] = {
        name = "Legendary Boa",
        givenItem = { "stringy", "legendsnakes", "snaket" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Stringy meat", "Legendary Boa pelt", "Snake tooth" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [674287411] = {
        ...
        givenItem = { "aligatormeat", "legaligators2", "aligatorto" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Alligator meat", "Legendary Sun Alligator pelt", "Alligator tooth" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-1598866821] = {
        ...
        givenItem = { "aligatormeat", "legaligators", "aligatorto" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Alligator meat", "Legendary Bull Alligator pelt", "Alligator tooth" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-1149999295] = {
        ...
        givenItem = { "stringy", "legbeavers2", "beavertail" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Stringy meat", "Legendary White Beaver pelt", "Beaver tail" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [2028722809] = {
        ...
        givenItem = { "pork", "legboars2", "boarmusk" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Pork", "Legendary Boar Pelt", "boarMusk" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-389300196] = {
        ...
        givenItem = { "pork", "legboars1", "boarmusk" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Pork", "Legendary Boar Pelt", "boarMusk" },
        money = 0,
        gold = 0,
    ...
    [-1433814131] = {
        ...
        givenItem = { "biggame", "legcougars2", "cougarf" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Big Game Meat", "Legendary Maza Cougar pelt", "Cougar tooth" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-1307757043] = {
        ...
        givenItem = { "stringy", "legcoyotes2", "coyotef" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Stringy Meat", "Legendary Midnight Paw Coyote pelt", "Coyote tooth" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-1189368951] = {
        ...
        givenItem = { "biggame", "legpanthers2", "panthere" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Big Game Meat", "Legendary Ghost Panther pelt", "Panther eyes" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-1392359921] = {
        ...
        givenItem = { "game", "wolftooth", "legwolfs2", "wolfheart" },
        givenAmount = { 1, 1, 1, 1 },
        givenDisplay = { "Game Meat", "wolf  tooth", "Legendary Onyx Wolf pelt", "Wolf Heart" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-511163808] = {
        ...
        givenItem = { "Mutton", "ramhorn", "legrams2" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Mutton", "Ramhorn", "Legendary Chalk Horn Ram Pelt" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-1754211037] = {
        name = "Legendary Buck",
        givenItem = { "buckantler", "legbucks1", "venison" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Venison", "Buck Antlers", "Legendary Buck pelt" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-915290938] = {
        ...
        givenItem = { "beef", "bisonhorn", "legbisons2" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Beef", "Bison Horn", "Legendary Winyan Bison pelt" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-117665949] = {
        ...
        givenItem = { "biggame", "mooseantler", "legmooses1" },
        givenAmount = { 1, 1, 1 },
        givenDisplay = { "Big Game Meat", "Moose Antlers", "Legendary Snowflake Moose pelt" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
